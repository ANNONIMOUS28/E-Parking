...
### configuración  temporal  de credenciales:
  Se permite el uso de contraseñas  temporales para conexión de la base de datos durante las  pruebas  de ejecución del proyecto.
  Antes de la entrega final,  el equipo establecerá  una contraseña  única para la ejecución del proyecto.


 ### pasos para configurar tu contraseña  de prueba:

 Abre el archivo  de conexiónDBjava en la ruta: "jdbc:mysql:locahthost: 3306/eparking?useSSL=false&serverTimezone=UTC",
 usuario = "root";
 password = "";
